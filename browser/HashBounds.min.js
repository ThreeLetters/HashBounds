...
HashBounds.prototype.truncateBounds=function(a,b,c,d,e){if(1===a.TYPE)a.x=Math.min(a.x,b),a.y=Math.min(a.y,c),a.x+a.width>d&&(a.width=d-a.x),a.y+a.height>e&&(a.height=e-a.y);else if(2===a.TYPE)a.minX=Math.max(a.minX,b),a.minY=Math.max(a.minY,c),a.maxX=Math.min(a.maxX,d),a.maxY=Math.min(a.maxY,e);else throw"ERR: Bound not formatted! Please make sure bounds were put through the convertBounds function";};
