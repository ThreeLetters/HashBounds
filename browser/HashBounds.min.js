...
Holder.prototype.everyAll=function(a,b){if(0===this.LEN)return!0;if(!this._every(a,b))return!1;if(0!==this.CHILDINDEX)for(var c=0;4>c;++c)if(!this.CHILDREN[c].everyAll(a,b))return!1;return!0};Holder.prototype.sub=function(){--this.LEN;null!=this.PARENT&&this.PARENT.sub()};Holder.prototype["delete"]=function(a,b){var c=a.hash.indexes[b],d=this.MAP[c]=this.MAP[this.MAP.length-1];d.hash.indexes[(this.X-d.hash.k1x)*(d.hash.k2y-d.hash.k1y+1)+this.Y-d.hash.k1y]=c;this.MAP.pop();this.sub()};
Holder.prototype.set=function(a,b){a.hash.indexes[b]=this.MAP.length;this.MAP.push(a);this.add()};var Grid=function(a,b,c,d,e){this.POWER=a;this.LEVEL=b;this.PREV=e;this.NEXT=null;this.QUERYID=1;this.PREV&&(this.PREV.NEXT=this);this.SIZEX=c;this.SIZEY=d;this.DATA={};this.init()};
Grid.prototype.init=function(){for(var a=0;a<this.SIZEX;++a){var b=a+32767<<16;if(this.PREV)var c=(a>>1)+32767<<16;for(var d=0;d<this.SIZEY;++d){var e=d>>1,f=b|d+32767,h=null;null!==this.PREV&&(h=this.PREV.DATA[c|e+32767]);this.DATA[f]=new Holder(h,a,d,this.POWER,this.LEVEL)}}};Grid.prototype.sendCreateAt=function(a,b){for(var c=a<<this.POWER,d=b<<this.POWER,e=this;e.PREV;)e=e.PREV;e.createAt(c>>e.POWER,d>>e.POWER)};
Grid.prototype.createAt=function(a,b){var c=null;null!==this.PREV&&(c=this.PREV.DATA[(a>>1)+32767<<16|(b>>1)+32767]);this.DATA[a+32767<<16|b+32767]=new Holder(c,a,b,this.POWER,this.LEVEL);if(this.NEXT){c=a<<1;var d=b<<1;this.NEXT.createAt(c,d);this.NEXT.createAt(c,d+1);this.NEXT.createAt(c+1,d);this.NEXT.createAt(c+1,d+1)}};Grid.prototype.getKey=function(a,b){return{x:a>>this.POWER,y:b>>this.POWER}};Grid.prototype._get=function(a,b){};
Grid.prototype.checkChange=function(a,b,c,d,e){return a.hash.k1x!=b||a.hash.k1y!=c||a.hash.k2x!=d||a.hash.k2y!=e};Grid.prototype.update=function(a,b){var c=b.minX>>this.POWER,d=b.minY>>this.POWER,e=b.maxX>>this.POWER,f=b.maxY>>this.POWER;return this.checkChange(a,c,d,e,f)?(this["delete"](a),this.insert(a,b,c,d,e,f),!0):!1};
